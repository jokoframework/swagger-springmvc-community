...
public class ApiListingScanner {
   ...
   public static Comparator<ApiDescription> apiDescriptionComparator = new Comparator<ApiDescription>() {
      public int compare(ApiDescription apiDesc1, ApiDescription apiDesc2) {
          scala.collection.immutable.List<Operation> operations1 = apiDesc1.operations();
          scala.collection.immutable.List<Operation> operations2 = apiDesc2.operations();
          Operation head1 = operations1.head();
          Operation head2 = operations2.head();
          return new Integer(head1.position()).compareTo(head2.position());
      }
    };
   ...
   public Map<String, ApiListing> scan() {
      ...
      for (Map.Entry<String, List<RequestMappingContext>> entry : resourceGroupRequestMappings.entrySet()) {
        ...
        Collections.sort(apiDescriptions, apiDescriptionComparator);
